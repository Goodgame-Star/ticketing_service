...
export default async function SalesTicketsPage({
  searchParams,
}: {
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-1">
            <p className="text-gray-500">
              Manage tickets created by you
            </p>
            <Link href="/sales/tickets/create" className="btn btn-primary btn-sm flex items-center gap-1.5" style={{ padding: "0.25rem 0.75rem" }}>
      ...
      <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
        {STATUS_FILTERS.map((s) => {
          ...
          const str = qs.toString();
          const href = `/sales/tickets${str ? `?${str}` : ""}`;
          return (
            <Link
              key={s}
              href={href}
                ...
                {tickets.map((t) => {
                  ...
                  return (
                    <tr key={t.id}>
                      ...
                      <td><Link href={`/sales/tickets/${t.id}`} className="btn btn-secondary btn-sm">Manage</Link></td>
                    </tr>
                  );
                })}
              </tbody>
